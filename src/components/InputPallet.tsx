...
export const InputPallet = ({ pallet, item, detailName }: Props) => {
    ...
    const { handleChecked, handleInputText, handleSwitch, handleInputArray, addRemoveSample, addTempPhoto, removeTempPhoto } = useContext(IntakeContext)
        ...
        <View style={{ ...globalStyles.flexBetween, marginBottom: 10 }}>
            {
                ...
                <View style={[globalStyles.flexRow, labelAlign, { width: "50%", maxWidth: "40%" }]}>
                    ...
                    />
                    <TextApp numberOfLines={2}>{item.label}</TextApp>
                </View>
            }
