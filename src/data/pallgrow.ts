...
export const pallgrowApples = (allSamples=1):DetailObject[] => [
    ...
    { check: false, tipe: "arrays", label: "Shrivelling (Heavy)", name: "shrivelling_heavy", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Skin Deffects", name: "skin_deffects", valor: new Array(Number(allSamples)).fill("0") },
...
export const pallgrowStrawberries = (allSamples=1):DetailObject[] => [
    ...
    { check: false, tipe: "arrays", label: "Bruises", name: "bruises", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Crown damage", name: "crown_damage", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Dehydration", name: "dehydration", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Dust/Sand", name: "dust_sand", valor: new Array(Number(allSamples)).fill("0") },

    { check: false, tipe: "arrays", label: "Flower remains", name: "flower_remains", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Freezing damage", name: "freezing_damage", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Heavy bruises", name: "heavy_bruises", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Insect damage", name: "insect_damage", valor: new Array(Number(allSamples)).fill("0") },

    { check: false, tipe: "arrays", label: "Misformed", name: "misformed", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Mechanical damage", name: "mechanical_damage", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Moldy crown", name: "moldy_crown", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Mould", name: "mould", valor: new Array(Number(allSamples)).fill("0") },

    { check: false, tipe: "arrays", label: "Rot", name: "rot", valor: new Array(Number(allSamples)).fill("0") },
    { check: false, tipe: "arrays", label: "Rot under the crown", name: "Rot_under_crown", valor: new Array(Number(allSamples)).fill("0") },
