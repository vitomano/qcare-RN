...
import { greenMain, grey, inactive, inputColor, lightGreen } from '../theme/variables';
        ...
        <View style={{ ...globalStyles.flexBetween, marginBottom: 10 }}>
...

            {
                ...
                <View style={{ width: "50%", flexDirection: "row", alignItems:"center" }}>
                    ...
                    {
                        item.photo === null &&
                        <View style={{backgroundColor: inputColor, width:10, height: 10}}>
                            <Icon name="camera-outline" size={20} color={grey} style={{ alignSelf: "center" }} />
                        </View>
                    }
                </View>
            }
            {
                ...
                <View style={{ width: "50%", flexDirection: "row", alignItems: "center" }}>
                    ...
                    {
                        item.photo === null &&
                        <View style={{backgroundColor: inputColor, width:40, height: 40, ...globalStyles.flexCenter}}>
